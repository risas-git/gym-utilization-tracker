...
* **Auf dem Emulator**: Klicke oben in der Menüleiste auf den grünen **Run-Button**. Falls kein Gerät vorhanden ist, erstelle eines über den **Device Manager** (z. B. Pixel 8, Android 14).
